...
class _DataState extends State<Data> {
  ...
  @override
  void initState() {
    _dataref = FirebaseDatabase.instance.ref('Grupos/Grupo4');
    super.initState();
  }
  ...
  Widget _crearListado(BuildContext context) {
    return Flexible(child: FirebaseAnimatedList(
        ...
        itemBuilder: (BuildContext context, DataSnapshot snapshot,
          ...
          if((snapshot.value as dynamic)["uplink_message"]["decoded_payload"] != null){
            humedad = ((snapshot.value as dynamic)["uplink_message"]["decoded_payload"]["humedad"] as double).toString();
          }
          if(((snapshot.value as dynamic)["uplink_message"]["decoded_payload"]) != null){
            temperatura = ((snapshot.value as dynamic)["uplink_message"]["decoded_payload"]["temp"]).toString();
          }
